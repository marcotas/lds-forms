...
Route::middleware('auth')->group(function () {
    ...
    Route::get('atas/print-next', 'Web\MinutesController@nextForm')->name('minutes.next-form');
    Route::get('atas/print-prev', 'Web\MinutesController@prevForm')->name('minutes.prev-form');
